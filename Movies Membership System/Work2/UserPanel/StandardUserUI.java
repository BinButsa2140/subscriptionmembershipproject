...
public class StandardUserUI extends JPanel implements UserUIInterface{//หน้าข้อมูล แบบพาแนล สำหรับ User
    ...
    public StandardUserUI(String str){
        this.str = str;
        this.infoarr = buttonbuilder.stdUser.get(str).split(",");
        isPremium = false;
    ...
    public void setComplementDataInformation(){//Override
        ...
        giantDayRemain.setBounds(0, 180+yinput, 370, 200);
    ...
    public void backButton(){//สร้างปุ่มกลับ เป็นการ override method จาก interface class
    ...
    public void FreeMoviePanel(){//เพิ่มหน้าต่างหนังสำหรับฟรี Overide
